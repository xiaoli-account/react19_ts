 ...
 * 主体布局路由
 */
export let layoutRoutes: RouteItem = {
  path: "/",
  name: "Layout",
...
export const configRoutes: RouteItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        name: "MenuManagement",
        component: () => import("@/pages/system-management/menu-management"),
        meta: {
          title: "菜单管理",
      ...
      },
      {
        ...
        name: "DictManagement",
        component: () => import("@/pages/system-management/dict-management"),
        meta: {
          title: "字典管理",
      ...
      },
      {
        ...
        component: () => import("@/pages/system-management/notice-management"),
        meta: {
          title: "通知公告",
      ...
      },
      {
        ...
        name: "DocumentCenter",
        component: () => import("@/pages/system-management/document-center"),
        meta: {
          title: "文档中心",
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: "reactflow-example",
        name: "ReactFlowExample",
        component: () => import("@/pages/examples/reactflow-example"),
        meta: {
          title: "ReactFlow v12.10.x 示例",
          i18n: "lee-layout-routes.ReactFlowExample",
          pagePermission: "page:examples:reactflow",
          requiresAuth: true,
          hidden: false,
          keepAlive: true,
        },
...
/**
 * 动态路由配置（需要权限控制） 布局路由+配置路由=动态路由
 */
export const asyncRoutes = () => {
  layoutRoutes.children = [...configRoutes];
  return layoutRoutes;
};
