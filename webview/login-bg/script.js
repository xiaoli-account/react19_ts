...
appNodes.pauseBtn.addEventListener("click", (e) => {
  e.stopPropagation();
  togglePause();
});

appNodes.soundBtn.addEventListener("click", (e) => {
  e.stopPropagation();
  toggleSound();
});

appNodes.settingsBtn.addEventListener("click", (e) => {
  e.stopPropagation();
  toggleMenu();
});
...
// window.addEventListener('keydown', handleKeydown); // 注释掉键盘事件，避免影响其他功能
